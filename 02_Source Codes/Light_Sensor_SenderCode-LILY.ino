...
uint8_t broadcastAddress[] = {0x34, 0x85, 0x18, 0x8E, 0x27, 0x6C}; //34:85:18:8E:29:18 60B: 34:85:18:AC:BD:6C; 59A: 0x34, 0x85, 0x18, 0x91, 0x30, 0xA4
...
void loop() {
 ...
 if (result == ESP_OK) {
    Serial.print(F("  Turbidity Of The Water : "));
    Serial.print(sensorValue_op);
    Serial.print(F(" Lux  "));
